...
mix.scripts([
    'resources/assets/admin/js/languages/index.js',
], 'public/assets/admin/js/languages/index.js').version();
...
mix.scripts([
    ...
    ], 'public/assets/app/js/bootstrap-confirmation.min.js'
).version();


mix.styles('resources/assets/admin/css/dev.css', 'public/assets/admin/css/dev.css').version();

mix.scripts('resources/assets/admin/js/dev.js', 'public/assets/admin/js/dev.js').version();
/*
 |--------------------------------------------------------------------------
 | Frontend
 |--------------------------------------------------------------------------
