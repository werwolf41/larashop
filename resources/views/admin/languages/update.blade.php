...
@section('title',__('views.admin.languages.Update.title') )

@section('content')
    <div class="row">
        <div class="col-md-12 col-sm-12 col-xs-12">
            {{ Form::open(['route'=>['admin.language.update', 'id'=>$language->id],'method' => 'put','class'=>'form-horizontal form-label-left', 'id'=>'language-update']) }}
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-6 col-sm-6 col-xs-12">
                        ...
                        <input id="name" type="text" class="form-control col-md-7 col-xs-12 @if($errors->has('name')) parsley-error @endif"
                               name="name" value="{{ $language->name }}" required>
                        @if($errors->has('name'))
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-6 col-sm-6 col-xs-12">
                        <input id="code" type="text" class="form-control col-md-7 col-xs-12 @if($errors->has('code')) parsley-error @endif"
                               name="code" value="{{ $language->code }}" required>
                        @if($errors->has('code'))
                            <ul class="parsley-errors-list filled">
                        ...
                        <div class="checkbox">
                            <label>
                                <input id="active" type="checkbox" class="@if($errors->has('active')) parsley-error @endif"
                                       name="active" @if( $language->active ) checked="checked" @endif value="1">
                        ...
                        <div class="checkbox">
                            <label>
                                <input id="primary" type="checkbox" class="@if($errors->has('primary')) parsley-error @endif"
                                       name="confirmed" @if( $language->primary ) checked="checked" @endif value="1">
...
@section('scripts')
    @parent
    {!! JsValidator::formRequest('App\Http\Requests\UpdateLanguageRequest', '#language-update')->render() !!}
@endsection